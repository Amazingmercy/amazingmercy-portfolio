...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BBGGpQuF.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BrDYdasa.js"),
    import("./start-BdIjIZj-.js"),
...
var ROUTER_BASEPATH = "amazingmercy-portfolio";
var SERVER_FN_BASE = "/amazingmercy-portfolio/_serverFn/";
